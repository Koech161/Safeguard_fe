...
export default function MpesaDonation() {
  ...
  return (
    <div className="p-8 bg-white shadow-xl dark:bg-gray-800 rounded-2xl">
      ...
      {/* Support Information */}
      <div className="p-4 mt-6 text-center rounded-lg bg-gray-50 dark:bg-gray-700">
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Need help with your donation? Contact us at{' '}
          <a href="mailto:support@safeguard.ai" className="text-green-600 hover:text-green-700 dark:text-green-400">
            support@safeguard.ai
          </a>
        </p>
      </div>
    </div>
